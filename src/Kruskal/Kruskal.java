 ...
 *
 * Minimum Sapnning Tree:  Minimum Spanning Tree is a set of edges in an undirected weighted graph that
 * connects all the vertices with no cycles and minimum total edge weight.
 */
